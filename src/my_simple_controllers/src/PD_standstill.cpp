...
bool PDstandstill::init(hardware_interface::EffortJointInterface* hw, 
...
void PDstandstill::starting(const ros::Time& time) {
...
PLUGINLIB_EXPORT_CLASS(my_simple_controllers::PDstandstill,
