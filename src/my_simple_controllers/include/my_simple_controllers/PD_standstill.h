#ifndef PD_STANDSTILL_CONTROLLER_H
#define PD_STANDSTILL_CONTROLLER_H
...
namespace my_simple_controllers {
  ...
  class PDstandstill : public controller_interface::Controller<hardware_interface::EffortJointInterface> {
    public:
