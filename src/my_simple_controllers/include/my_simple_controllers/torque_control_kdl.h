#ifndef TORQUE_CONTROLLER_KDL_H
#define TORQUE_CONTROLLER_KDL_H
...
namespace my_simple_controllers
{
    ...
    class TorqueControllerKDL : public controller_interface::Controller<hardware_interface::EffortJointInterface>
    {
    public:
